...
class MorpheusUplinkIpamProvider implements IPAMProvider, DNSProvider {
	...
	List<OptionType> getIntegrationOptionTypes() {
		return [
                ...
                new OptionType(code: 'morpheus.zoneFilter', name: 'Zone Filter', inputType: OptionType.InputType.TEXT, fieldName: 'zoneFilter', fieldLabel: 'Zone Filter', helpText: "A comma ',' delimited list of Zones to sync", required: false, displayOrder: 7),
